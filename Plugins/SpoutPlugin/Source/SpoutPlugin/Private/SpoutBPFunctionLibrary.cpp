...
void GetDevice()
{
	UE_LOG(LogTemp, Warning, TEXT("-----------> Set Graphics Device D3D11"));
...
FSenderStruct* RegisterReceiver(FName spoutName) {
	...
	UE_LOG(LogTemp, Warning, TEXT("--- Creating d3d11 Texture 2D---"));
...
bool USpoutBPFunctionLibrary::CreateRegisterSender(FName spoutName, ID3D11Texture2D* baseTexture)
{
	...
	UE_LOG(LogTemp, Warning, TEXT("ID3D11Texture2D Info : width_%i, height_%i"), desc.Width, desc.Height);
	UE_LOG(LogTemp, Warning, TEXT("ID3D11Texture2D Info : Format is %i"), int(desc.Format));
...
bool USpoutBPFunctionLibrary::SpoutReceiver(const FName spoutName, UMaterialInstanceDynamic*& mat, UTexture2D*& texture)
{
	...
	if (BaseMaterial == NULL)
	{
		...
		mBase_Material = LoadObject<UMaterial>(NULL, TEXT("/DGS/SpoutMaterial.SpoutMaterial"), NULL, LOAD_None, NULL);
...
bool USpoutBPFunctionLibrary::UpdateRegisteredSpout(FName spoutName, ID3D11Texture2D* baseTexture)
{
	...
	UE_LOG(LogTemp, Warning, TEXT("ID3D11Texture2D Info : ancho_%i, alto_%i"), desc.Width, desc.Height);
	UE_LOG(LogTemp, Warning, TEXT("ID3D11Texture2D Info : Format is %i"), int(desc.Format));
