...
#define LOCTEXT_NAMESPACE "FSpoutPlugin"

void FSpoutPluginModule::StartupModule()
{
...
void FSpoutPluginModule::ShutdownModule()
{
...
IMPLEMENT_MODULE(FSpoutPluginModule, SpoutPlugin)
